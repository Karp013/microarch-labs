...
#Switches
set_property -dict {PACKAGE_PIN J15 IOSTANDARD LVCMOS33} [get_ports rstn_i]
...
### LEDs
set_property -dict {PACKAGE_PIN H17 IOSTANDARD LVCMOS33} [get_ports {counter1_o[0]}]
set_property -dict {PACKAGE_PIN K15 IOSTANDARD LVCMOS33} [get_ports {counter1_o[1]}]
set_property -dict {PACKAGE_PIN J13 IOSTANDARD LVCMOS33} [get_ports {counter1_o[2]}]
set_property -dict {PACKAGE_PIN N14 IOSTANDARD LVCMOS33} [get_ports {counter1_o[3]}]
set_property -dict {PACKAGE_PIN R18 IOSTANDARD LVCMOS33} [get_ports {counter1_o[4]}]
set_property -dict {PACKAGE_PIN V17 IOSTANDARD LVCMOS33} [get_ports {counter1_o[5]}]
set_property -dict {PACKAGE_PIN U17 IOSTANDARD LVCMOS33} [get_ports {counter1_o[6]}]
set_property -dict {PACKAGE_PIN U16 IOSTANDARD LVCMOS33} [get_ports {counter1_o[7]}]

set_property -dict {PACKAGE_PIN V16 IOSTANDARD LVCMOS33} [get_ports {counter2_o[0]}]
set_property -dict {PACKAGE_PIN T15 IOSTANDARD LVCMOS33} [get_ports {counter2_o[1]}]
set_property -dict {PACKAGE_PIN U14 IOSTANDARD LVCMOS33} [get_ports {counter2_o[2]}]
set_property -dict {PACKAGE_PIN T16 IOSTANDARD LVCMOS33} [get_ports {counter2_o[3]}]
set_property -dict {PACKAGE_PIN V15 IOSTANDARD LVCMOS33} [get_ports {counter2_o[4]}]
set_property -dict {PACKAGE_PIN V14 IOSTANDARD LVCMOS33} [get_ports {counter2_o[5]}]
set_property -dict {PACKAGE_PIN V12 IOSTANDARD LVCMOS33} [get_ports {counter2_o[6]}]
set_property -dict {PACKAGE_PIN V11 IOSTANDARD LVCMOS33} [get_ports {counter2_o[7]}]
...
#set_property -dict {PACKAGE_PIN N17 IOSTANDARD LVCMOS33} [get_ports en_i]
...
connect_debug_port u_ila_0/probe0 [get_nets [list {cnt_o_OBUF[0]} {cnt_o_OBUF[1]} {cnt_o_OBUF[2]} {cnt_o_OBUF[3]} {cnt_o_OBUF[4]} {cnt_o_OBUF[5]} {cnt_o_OBUF[6]} {cnt_o_OBUF[7]}]]
connect_debug_port u_ila_0/probe1 [get_nets [list en_i_IBUF]]
...
connect_debug_port u_ila_0/probe0 [get_nets [list {counter2_o_OBUF[0]} {counter2_o_OBUF[1]} {counter2_o_OBUF[2]} {counter2_o_OBUF[3]} {counter2_o_OBUF[4]} {counter2_o_OBUF[5]} {counter2_o_OBUF[6]} {counter2_o_OBUF[7]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe1]
set_property port_width 8 [get_debug_ports u_ila_0/probe1]
connect_debug_port u_ila_0/probe1 [get_nets [list {counter1_o_OBUF[0]} {counter1_o_OBUF[1]} {counter1_o_OBUF[2]} {counter1_o_OBUF[3]} {counter1_o_OBUF[4]} {counter1_o_OBUF[5]} {counter1_o_OBUF[6]} {counter1_o_OBUF[7]}]]
